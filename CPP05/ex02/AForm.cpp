...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/15 16:49:54 by sdiouane          #+#    #+#             */
/*   Updated: 2025/02/15 16:49:55 by sdiouane         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void AForm::setIs_signed(bool value) { this->is_signed = value; }

void AForm::setGradsign(int value) { this->grade_sign = value; }

void AForm::setGradexecute(int value) { this->grade_execute = value; }

bool AForm::getIs_signed() const { return is_signed; }

int AForm::getGradsign() const { return grade_sign; }

int AForm::getGradexecute() const { return grade_execute; }
